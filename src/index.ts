...
import * as MyComponent from '@/components/index'
...
export default {
    install(app: App){
        ...
        app.use(TuiGrid)
        app.use(VueKonva)
        // app.component('JajagUI', MyComponent)
...
const {
    ...
    GridTable,
    Editor,
    FullscreenProgress} = MyComponent
// export {
//     Feedback, Utils, Excel, useProgress, useNavigation, useRequestDefence,
//     MainLayout,
//     PageHeader,
//     PageBody,
//     BasicDialog,
